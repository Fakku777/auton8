...
export class BaritoneBuilder implements INodeType {
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		for (let i = 0; i < items.length; i++) {
			try {
				...
				switch (operation) {
					case 'build':
						const schematicFile = this.getNodeParameter('schematicFile', i) as string;
						const originX = this.getNodeParameter('originX', i) as string;
						const originY = this.getNodeParameter('originY', i) as string;
						const originZ = this.getNodeParameter('originZ', i) as string;
					...
					case 'clearArea':
						const clearX1 = this.getNodeParameter('x1', i) as number;
						const clearY1 = this.getNodeParameter('y1', i) as number;
						const clearZ1 = this.getNodeParameter('z1', i) as number;
						const clearX2 = this.getNodeParameter('x2', i) as number;
						const clearY2 = this.getNodeParameter('y2', i) as number;
						const clearZ2 = this.getNodeParameter('z2', i) as number;
					...
					case 'fillArea':
						const fillX1 = this.getNodeParameter('x1', i) as number;
						const fillY1 = this.getNodeParameter('y1', i) as number;
						const fillZ1 = this.getNodeParameter('z1', i) as number;
						const fillX2 = this.getNodeParameter('x2', i) as number;
						const fillY2 = this.getNodeParameter('y2', i) as number;
						const fillZ2 = this.getNodeParameter('z2', i) as number;
						const fillBlockType = this.getNodeParameter('blockType', i) as string;
					...
					case 'mine':
						const targetBlocks = this.getNodeParameter('targetBlocks', i) as string;
						const mineCount = this.getNodeParameter('mineCount', i) as number;
					...
					case 'farm':
						const farmRange = this.getNodeParameter('farmRange', i) as number;
						command = `#farm ${farmRange}`;
						break;

					case 'tunnel':
						const tunnelHeight = this.getNodeParameter('tunnelHeight', i) as number;
						const tunnelWidth = this.getNodeParameter('tunnelWidth', i) as number;
						const tunnelLength = this.getNodeParameter('tunnelLength', i) as number;
