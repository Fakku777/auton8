...
public final class ChatBridge implements Bridge {
    ...
    public ChatBridge(Config cfg, MinescriptClient client, BaritoneBridge baritone) {
        this.cfg = cfg;
        this.client = client;
    ...
    private void publishChat(String from, String msg, String source) {
        ...
        client.publish(cfg.evtEndpoint, JsonUtils.chatEvent(f, msg, source));
    }
        ...
        try {
            ...
            if ("say".equals(type) && cfg.allowChatTx) {
                ...
                mc.execute(() -> {
                    ...
                    client.publish(cfg.evtEndpoint, JsonUtils.baseEvent("said", msgOut));
                });
            }
